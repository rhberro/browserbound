      ...
      <div class="w-full max-w-md">
        ...
        <div class="space-y-3">
          ...
          <button
            ...
            class="w-full bg-slate-700 hover:bg-slate-600 text-white font-semibold py-3 px-4 rounded transition"
          >
            Settings
          </button>
          <button
            onClick={handleSignOut}
            class="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-4 rounded transition"
          >
            Sign Out
          </button>
        </div>
